...
public class AppearanceTab : EditTab
{
    ...
    protected override void DrawContents(Listing_Standard ui)
    {
        DrawOverride(
            ...
            "FactionLoadout_Appearance_Beards".Translate().ToString(),
            DrawBeardStyles,
        ...
        DrawOverride(
            ...
            "FactionLoadout_Appearance_Hair".Translate().ToString(),
            DrawHairStyles,
        ...
        DrawOverride(
            ...
            "FactionLoadout_Appearance_HairColors".Translate().ToString(),
            DrawHairColors,
        ...
        DrawOverride(
            ...
            "FactionLoadout_Appearance_BodyTypes".Translate().ToString(),
            DrawBodyTypes,
